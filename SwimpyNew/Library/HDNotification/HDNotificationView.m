...
#define NOTIFICATION_VIEW_SHOWING_DURATION                  4.0f    /// second(s)
...
- (void)setUpUI
{
    ...
    [_lblTitle setFont:[UIFont fontWithName:@"Avenir-Bold" size:LABEL_TITLE_FONT_SIZE]];
    ...
    [_lblMessage setFont:[UIFont fontWithName:@"Avenir" size:LABEL_MESSAGE_FONT_SIZE]];
